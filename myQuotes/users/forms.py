...
class RegisterForm(UserCreationForm):
    ...
    password1 = CharField(max_length=20, required=True, min_length=8,
                          widget=PasswordInput(attrs={'class': 'form-control'}))
    password2 = CharField(max_length=20, required=True, min_length=8,
                          widget=PasswordInput(attrs={'class': 'form-control'}))
...
class LoginForm(AuthenticationForm):
    username = CharField(max_length=150, required=True, widget=TextInput(attrs={'class': 'form-control'}))
    password = CharField(max_length=20, required=True, min_length=8,
                         widget=PasswordInput(attrs={'class': 'form-control'}))
